...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative min-h-screen flex items-center overflow-hidden kh-mesh-bg bg-[var(--kh-bg)]"
    >
      {/* Image de fond */}
      <motion.div
        initial={{ scale: 1.08 }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 w-full pt-28 pb-20">
        ...
        >
          ...
          <motion.div
            variants={item}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full kh-glass text-sm font-bold text-[var(--kh-primary)] mb-6 shadow-sm"
          >
          ...
          <motion.h1
            variants={item}
            className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[var(--kh-primary)] drop-shadow-sm"
          >
          ...
          <motion.p
            variants={item}
            className="mt-6 text-lg text-[var(--kh-text)]/90 leading-relaxed max-w-xl"
          >
          ...
          >
            <a
              ...
              className="group kh-gradient-btn kh-glow inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full text-base font-bold transition-transform hover:scale-105"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full text-base font-bold text-[var(--kh-primary)] kh-glass hover:bg-[var(--kh-surface)] transition border border-[var(--kh-border)] shadow-sm"
            >
          ...
          >
            {[
              ...
              { value: "5 min", label: "Pour recevoir une offre" },
            ].map((stat) => (
              <div key={stat.label}>
                <div className="text-2xl sm:text-3xl font-extrabold kh-gradient-text">
                  {stat.value}
                </div>
                <div className="text-sm font-semibold text-[var(--kh-text)]/80 mt-1">
                  {stat.label}
                </div>
              </div>
            ))}
